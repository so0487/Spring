	...
	<%@include file="/WEB-INF/views/include/left.jsp"%>
		...
		<div class="content-body">
			<div class="row justify-content-between align-items-center mb-10">
				...
				</div><!-- col-12 col-lg-auto mb-20 -->
			</div><!-- row justify-content-between align-items-center mb-10 -->
			
			<div class="row">
				<!-- 헤더 화면 -->
				<div class="col-lg-12 col-md-6 col-12 mb-30">
					<input type="image" src="<%=request.getContextPath()%>/resources/img/school.jpg">
				</div>
		</div><!-- row end -->
			...
			<div class="col-lg-12 mb-20">
	             <div class="box-body">
	                 <ul class="nav nav-tabs mb-20">
	                     <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#home">교육과정 조회</a></li>
	                     <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#profile">공지사항</a></li>
	                     <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#contact">QnA</a></li>
	                 </ul>
